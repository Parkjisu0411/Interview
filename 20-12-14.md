...
**final class**는 하위 class를 가질 수 없다. 즉, 다른 class에서 final로 정의된 class를 상속받을 수 없다.
**final method**는 하위 class에서 Overrind 할 수 없다.
### 4.연습문제 7-22 번을 푸시오.
```java
...
**class**는 객체를 생성할 수 있고 method의 body 또한 작성 가능하다.     
